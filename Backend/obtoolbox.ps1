...
Function Get-OBModules {
    ...
    Write-Host "Downloaded Module $fileName"
}
if (-Not $testing) {
    ForEach ($psm1Url in $modulearray) {
        Get-OBModules $psm1Url
    }
}
else {
    ...
    pause
    Get-OBModules "https://github.com/obmmoreno/obwinrepair/releases/download/obtoolbox-TUI/dentalsoftware.psm1"
    Get-OBModules "https://github.com/obmmoreno/obwinrepair/releases/download/obtoolbox-TUI/ob.psm1"
}
